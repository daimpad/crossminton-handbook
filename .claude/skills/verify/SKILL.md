...
13. Zwei Stufen (Beginner + Fortgeschritten-Technik): Kompetenzpfad ist kumulativ. Beginner-Diagnose → 23 Stationen (kein Fortgeschritten sichtbar). Fortgeschritten-Diagnose (`#/pfad/kompetenz/fortgeschritten`) → 29 Stationen, Beginner-Block (1–23) dann Fortgeschritten-Block (24–29, `beinarbeit_system` zuletzt). Stufenübergreifende weiche Voraussetzung erscheint als „Empfohlen vorher"-Hinweis (z. B. `beinarbeit_system` → Beginner-`beinarbeit`), sperrt nie. Cross-Sport BAD: 8 Deltas im kumulativen Pfad; Geometrie-Delta an `beinarbeit_system` (Quadrat vs. Netz), Bündelung an `handgelenk_peitsche` → `vorhand_drive`.
