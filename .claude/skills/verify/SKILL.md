...
12. Zwei Domänen (Technik + Taktik): Kompetenzpfad Beginner = 12 Stationen, Technik-Block (1–6) dann Taktik-Block (7–12), `fehler_vermeiden` zuletzt (Rückverzweigung). Themenpfad zeigt beide Facetten (je 6). Reflexionsaufgabe (z. B. `spielziel_verstehen`): eigener Abschnitt mit „Mitgenommen"-Button; Baustein erst absolviert, wenn Erklärteil UND Reflexion quittiert. Cross-Sport: `aufschlag_taktisch` trägt bei Herkunft BAD im Kompetenz-Kontext das Delta, im Themen-Kontext nicht.
