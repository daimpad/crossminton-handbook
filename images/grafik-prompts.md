...
- **Diagramme** (Feld, Positionen, Flugbahnen, Formationen, Bemaßung) werden als **theme-fähiges Inline-SVG** hand-gezeichnet — nutzen die CI-Tokens, kippen mit dem Umschalter, sind gestochen scharf und winzig. Nummern im `SVG_GRAFIKEN`-Set (`js/oberflaeche.js`); zu jeder liegt **`G-XXX.svg` UND `G-XXX.png`** (Fallback) vor. **Erledigt: G-023–027, G-031, G-037–042, G-044–046, G-048–052, G-060 (21 Diagramme, alle Doppel-Positionen komplett).** Kandidaten (rein diagrammatisch, offen): Taktik-Sequenzen (G-028 Punkt aufbauen, G-029 Smash vorbereiten, G-030 Gegner-Typen), G-014 (Beinarbeit-System), G-055 (Wind), G-059 (Böden), G-061 (Schiedsrichter-Zeichen).
